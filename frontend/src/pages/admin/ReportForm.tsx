...
const sectionClass = "rounded-[32px] border border-slate-200 bg-white p-4 text-slate-900 shadow-sm sm:p-6";
...
export default function ReportForm() {
  ...
  const lockNonRequiredSections = role !== "TEKNISI";
            ...
            <Field label="Dispatch No" required error={errors.dispatchNo?.message}>
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                ...
                <button
                  ...
                  className="rounded-xl bg-slate-700 px-4 py-2 text-sm font-semibold text-white sm:py-0"
            ...
            <div className="mt-3 flex flex-wrap gap-4 md:gap-6">
              ...
              {problemPhotos.map((photo, index) => (
                ...
                <div
                  ...
                  className="relative w-full max-w-[220px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm"
              ...
              {problemPhotos.length < MAX_PROBLEM_PHOTOS &&
                ...
                Array.from({ length: MAX_PROBLEM_PHOTOS - problemPhotos.length }).map((_, idx) => (
                  ...
                  <div
                    ...
                    className="flex h-32 w-full max-w-[220px] flex-col items-center justify-center rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-100 via-slate-50 to-white text-sm text-slate-600 shadow-inner"
              ...
              <label className="flex h-32 w-full max-w-[220px] cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-white/80 text-center text-sm font-semibold text-slate-600 transition hover:border-slate-400">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <p className="w-full text-sm font-semibold text-slate-700 sm:w-1/3">Departure</p>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <p className="w-full text-sm font-semibold text-slate-700 sm:w-1/3">Return</p>
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <p className="w-full text-sm font-semibold text-slate-700 sm:w-1/3">Time</p>
              ...
              <div className="rounded-2xl border border-slate-700/40 bg-white/80 p-4">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <p className="w-full text-sm font-semibold text-slate-700 sm:w-1/3">Duration</p>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1.3fr,1fr]">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-slate-700/40 bg-white/80 p-4">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm font-semibold uppercase tracking-wide text-slate-600">Carried out by</p>
                    ...
                    <p className="text-center text-xs font-semibold uppercase tracking-wide text-slate-500">Service Engineer</p>

                  </div>

                  <div className="space-y-3">

                    <p className="text-sm font-semibold uppercase tracking-wide text-slate-600">Sign / Approved by</p>
                    ...
                    <p className="text-center text-xs font-semibold uppercase tracking-wide text-slate-500">Customer Acknowledgment</p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button type="button" className="flex-1 rounded-xl bg-slate-700 px-5 py-2 text-sm font-semibold text-white sm:flex-auto">

                  Finalized

                </button>

                <button type="button" className="flex items-center gap-2 rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700">
